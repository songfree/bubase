...
202505：版本2.1.6   合并更新，修改bf_Tools增加C的加解密函数等等
...
202406：版本2.1.1   修改cgate,优化网关订阅支持全量订阅,并支持在客户端断开时，发断开消息到总线
202401：版本2.1.0   增加监控mfc终端,修改总线广播时多发的bug，修改windows下的工具及一些代码的优化等等
202311：版本2.0.13  优化内存表基类  
