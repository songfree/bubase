...
void CLogViewDlg::DisplayHead()
{
	...
	if (m_bIsDrebLog)
	{
		...
		m_lstLogHead.InsertColumn(0, "序号", LVCFMT_CENTER, 80);
		m_lstLogHead.InsertColumn(1, "时间", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(2, "微秒", LVCFMT_CENTER, 100);
		m_lstLogHead.InsertColumn(3, "进程", LVCFMT_CENTER, 80);
		m_lstLogHead.InsertColumn(4, "cZip", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(5, "cCmd", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(6, "cRaflag", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(7, "cNextFlag", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(8, "cDrebAffirm", LVCFMT_CENTER, 140);
		m_lstLogHead.InsertColumn(9, "s_nNodeId", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(10, "s_cNodePrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(11, "s_nSvrMainId", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(12, "s_cSvrPrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(13, "s_nHook", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(14, "s_nSerial", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(15, "s_nDrebSerial", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(16, "s_nGateIndex", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(17, "s_nIndex", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(18, "d_nNodeId", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(19, "d_cNodePrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(20, "d_nSvrMainId", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(21, "d_cSvrPrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(22, "d_nServiceNo", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(23, "a_nNodeId", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(24, "a_cNodePrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(25, "a_nRetCode", LVCFMT_CENTER, 140);
		m_lstLogHead.InsertColumn(26, "n_nNextNo", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(27, "n_nNextOffset", LVCFMT_CENTER, 180);
		m_lstLogHead.InsertColumn(28, "b_cIndex", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(29, "b_nSerial", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(30, "nLen", LVCFMT_CENTER, 120);
	}
	else
	{
		m_lstLogHead.SetExtendedStyle(LVS_EX_FULLROWSELECT|LVS_EX_GRIDLINES|LVS_EX_HEADERDRAGDROP);
		...
		m_lstLogHead.InsertColumn(2, "微秒", LVCFMT_CENTER, 100);
		m_lstLogHead.InsertColumn(3, "进程", LVCFMT_CENTER, 80);
		m_lstLogHead.InsertColumn(4, "cMsgType", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(5, "nMsgFlag", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(6, "nIndex", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(7, "nBpuIndex", LVCFMT_CENTER, 120);
		
		m_lstLogHead.InsertColumn(8, "cZip", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(9, "cCmd", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(10, "cRaflag", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(11, "cNextFlag", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(12, "cDrebAffirm", LVCFMT_CENTER, 140);
		m_lstLogHead.InsertColumn(13, "s_nNodeId", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(14, "s_cNodePrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(15, "s_nSvrMainId", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(16, "s_cSvrPrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(17, "s_nHook", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(18, "s_nSerial", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(19, "s_nDrebSerial", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(20, "s_nGateIndex", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(21, "s_nIndex", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(22, "d_nNodeId", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(23, "d_cNodePrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(24, "d_nSvrMainId", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(25, "d_cSvrPrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(26, "d_nServiceNo", LVCFMT_CENTER, 160);
		m_lstLogHead.InsertColumn(27, "a_nNodeId", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(28, "a_cNodePrivateId", LVCFMT_CENTER, 200);
		m_lstLogHead.InsertColumn(29, "a_nRetCode", LVCFMT_CENTER, 140);
		m_lstLogHead.InsertColumn(30, "n_nNextNo", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(31, "n_nNextOffset", LVCFMT_CENTER, 180);
		m_lstLogHead.InsertColumn(32, "b_cIndex", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(33, "b_nSerial", LVCFMT_CENTER, 120);
		m_lstLogHead.InsertColumn(34, "nLen", LVCFMT_CENTER, 120);
	}
}
