...
void CShareData::Run(bool isstop, int sendnum,int sendbyte, int rcvnum,int rcvbyte, int errnum, INT64_ resptime,int rsppacknum)
{
...
void CShareData::RunPush(int rcvbyte,int rcvnum)
{
	CBF_PMutex pp(&m_runMutex);
	m_nRcvPushNum+=rcvnum;
	m_nRcvByte+=rcvbyte;
