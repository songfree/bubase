...
CKVNode* CKvData::GetValueByName(std::string name,int &ivalue)
{
	std::string svalue;
	CKVNode* retnode = GetValueByName(name,svalue);
	if (retnode == NULL)
	{
		return NULL;
	}
...
CKVNode* CKvData::GetValueByName(std::string name,short &ivalue)
{
	std::string svalue;
	CKVNode* retnode = GetValueByName(name,svalue);
	if (retnode == NULL)
...
CKVNode* CKvData::GetValueByName(std::string name,long &ivalue)
{
	std::string svalue;
	CKVNode* retnode = GetValueByName(name,svalue);
	if (retnode == NULL)
	...
	ivalue = atol(svalue.c_str());
	return retnode;
}
CKVNode* CKvData::GetValueByName(std::string name,double &ivalue)
{
	std::string svalue;
	CKVNode* retnode = GetValueByName(name,svalue);
	if (retnode == NULL)
...
CKVNode* CKvData::GetValueByName(std::string name,unsigned int &ivalue)
{
	std::string svalue;
	CKVNode* retnode = GetValueByName(name,svalue);
	if (retnode == NULL)
...
CKVNode* CKvData::GetValueByName(std::string name,unsigned short &ivalue)
{
	std::string svalue;
	CKVNode* retnode = GetValueByName(name,svalue);
	if (retnode == NULL)
...
CKVNode* CKvData::GetValueByName(std::string name,unsigned long &ivalue)
{
	std::string svalue;
	CKVNode* retnode = GetValueByName(name,svalue);
	if (retnode == NULL)
...
int CKvData::setHead(std::string key, std::string svalue)
{
	...
	for (unsigned int i=0; i< 12; i++)
	{
		...
		{
			CBF_Tools::StringCopy(item[i],itemlen[i],svalue.c_str());
...
int CKvData::setPack(std::string key, short svalue, bool flag)
{
	char tmpchar[100];
	sprintf(tmpchar,"%d",svalue);
	return setPack(key,tmpchar,flag);
}
int CKvData::setPack(std::string key, int svalue, bool flag)
{
	char tmpchar[100];
	sprintf(tmpchar,"%d",svalue);
	return setPack(key,tmpchar,flag);
}
int CKvData::setPack(std::string key, long svalue, bool flag)
{
	char tmpchar[100];
	sprintf(tmpchar,INT64PFM,svalue);
	return setPack(key,tmpchar,flag);
}
int CKvData::setPack(std::string key, double svalue, bool flag)
{
	char tmpchar[100];
	sprintf(tmpchar,"%f",svalue);
	return setPack(key,tmpchar,flag);
}
int CKvData::setPack(std::string key, unsigned short svalue, bool flag)
{
	char tmpchar[100];
	sprintf(tmpchar,"%d",svalue);
	return setPack(key,tmpchar,flag);
}
int CKvData::setPack(std::string key, unsigned int  svalue, bool flag)
{
	char tmpchar[100];
	sprintf(tmpchar,"%ld",svalue);
	return setPack(key,tmpchar,flag);
}
int CKvData::setPack(std::string key, unsigned long svalue, bool flag)
{
	char tmpchar[100];
	sprintf(tmpchar,INT64PFM,svalue);
	return setPack(key,tmpchar,flag);
